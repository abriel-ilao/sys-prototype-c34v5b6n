    ...
    <div class="container panel-x">
        ...
        <div class="col-12">
          ...
          <div id="accordion-1" class="accordion m-2">
            <div class="card">
              ...
              <div id="january" class="remove_collapse" aria-labelledby="jan" data-parent="#accordionExample">
        ...
        <div class="col-12 col-lg-4">
          <div id="accordion-2" class="accordion m-2">
            <div class="card">
              ...
              <div id="february" class="remove_collapse" aria-labelledby="feb" data-parent="#accordionExample">
        ...
        <div class="col-12 col-lg-4">
          <div id="accordion-3" class="accordion m-2">
            <div class="card">
              ...
              <div id="march" class="remove_collapse" aria-labelledby="mar" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="april" class="remove_collapse" aria-labelledby="apr" data-parent="#accordionExample">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
              ...
              <div id="may" class="remove_collapse" aria-labelledby="_may" data-parent="#accordionExample">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
              ...
              <div id="june" class="remove_collapse" aria-labelledby="jun" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="july" class="remove_collapse" aria-labelledby="jul" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="august" class="remove_collapse" aria-labelledby="aug" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="september" class="remove_collapse" aria-labelledby="sept" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="october" class="remove_collapse" aria-labelledby="oct" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="november" class="remove_collapse" aria-labelledby="nov" data-parent="#accordionExample">
            ...
            <div class="card">
              ...
              <div id="december" class="remove_collapse" aria-labelledby="dec" data-parent="#accordionExample">
...
<script type="text/javascript">
	...
	function transactionLog(selectedYear, m) {
		...
		$.ajax({
				...
				method:"post",
				data:{year:selectedYear, month:m, level:level, hideLog:1},
