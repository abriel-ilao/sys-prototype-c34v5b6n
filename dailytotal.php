              ...
              ?>
                  <div class="col-sm-8 col-md-6">
                      <div class="pos-sub-item">
                        <ul>
                          <li><a href="dailytotal" class="active-sub-item"><i class="fa fa-calculator"></i> Daily Total</a></li>
                          <li><a href="adddailytotal"><i class="fa fa-shopping-bag"></i> Add D.T.</a></li>
                        </ul>
                      </div>
                  </div>
              <?php
    ...
    <div class="header-pad">
          ...
          <div class="row">
              <div class="col-12 col-md-6">
                  <h1 class="h6 mt-2"><i class="fa fa-cart-arrow-down"></i> Daily Total <span class="m-sub-menu-link float-right"><a href="adddailytotal" class="text-info"><i class="fa fa-shopping-bag"></i> Add D.T.</a></h1>
              </div>
              <div class="col-12 col-md-6">
              </div>
          </div>
    ...
    <div class="container panel-x">
        ...
        <div class="col-12">
          <div class="h6-responsive h-inventory" id="add">
            <form action="dailytotal" method="POST" role="form">
              ...
              <?= $DailyTotal->getNotification(); ?>
            </form>
          </div>
          <?= $DailyTotal->setYearlyNetSales();?>
        </div>
...
<script type="text/javascript">
  $(document).ready(function()
    {
      $('.btn-delete-daily-total').click(function(e) {
        ...
        //please wait
          ...
          var target_id = $(this).attr("data-id");
            $('#selected-total-daily-'+target_id).remove();

          $.ajax({
              url: "server-ajax/dailytotaldelajax",
              type: "POST",
              data: "id_daily_total=" + target_id,
              success: function() {
                //hide please wait
