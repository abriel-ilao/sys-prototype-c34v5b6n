...
<div class="col-sm-8 col-md-6">
    ...
    <div class="col-auto">
      <label class="sr-only" for="inlineFormInputGroup">Search Return Items / Refundables</label>
      <div class="input-group">
        <input type="text" class="form-control" id="searchText" placeholder="Search Return Items / Refundables">
...
?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-auto">
                      <label class="sr-only" for="inlineFormInputGroup">Search Return Items / Refundables</label>
                      <div class="input-group">
                        <input type="text" class="form-control" id="m-searchText" placeholder="Search Return Items / Refundables">
                        <div class="input-group-prepend">
                          <div class="input-group-text"><i class="fa fa-search"></i></div>
                        </div>
                      </div>
    ...
    <?php
      @$cookie = $_COOKIE["return-product-item"];
    ?>
      <div class="row">
          <div class="col-12">
            <div class="h6-responsive h-inventory" id="add"><i class="fa fa-undo-alt"></i> Return Items / Refundables</div>
            <?php if($cookie == null) : ?>
            <h4 class="h-class h4-responsive mt-5 mb-5" style="color:silver;">Product item goes here...</h4>
            <?php endif; ?>
            <div class="transaction-add-item">
            <!-- /* I stopped here */ -->
            <?php $returnItems->readData(); ?>
            </div>
          </div>
      </div>
    </div>
